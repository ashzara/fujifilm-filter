...
// Neutralizer should be conservative — fix WB and barely touch exposure.
// The film grade does the aesthetic lifting; stacking both causes the washed look.
const CURVES = {
  flash:       [  0, 122, 248 ],  // WB only, no exposure shift
  lowlight:    [  3,  98, 242 ],  // gentle nudge, keep moody
  daylight:    [  4, 120, 242 ],  // near-neutral — just clips and very soft lift
  overexposed: [  5, 106, 230 ],  // pull highlights down, mild shadow lift
};
