...
async function postProcess(pixels, width, height, sceneType) {
  ...
  // 3. Vignette — corners darken, draws eye inward
  //    Flash scenes get a stronger vignette (studio look).
  const vigStrength = sceneType === 'flash' ? 0.62 : 0.52;
  applyVignette(pixels, width, height, vigStrength);
